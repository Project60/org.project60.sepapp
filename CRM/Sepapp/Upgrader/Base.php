 ...
 */
class CRM_Sepapp_Upgrader_Base
{
    ...
    static public function instance()
    {
        if (!self::$instance) {
            // FIXME auto-generate
            self::$instance = new CRM_Sepapp_Upgrader(
     ...
     *
     * @code
     * CRM_Sepapp_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
     * @endcode
     */
    ...
    public function executeSqlTemplate($tplFile)
    {
        ...
        $tplFile = CRM_Utils_File::isAbsolute(
            $tplFile
        ) ? $tplFile : $this->extensionDir . DIRECTORY_SEPARATOR . $tplFile;
    ...
    private function deleteDeprecatedRevision()
    {
        if ($this->revisionStorageIsDeprecated) {
            ...
            CRM_Core_Error::debug_log_message(
                "Migrated extension schema revision ID for {$this->extensionName} from civicrm_setting (deprecated) to civicrm_extension.\n"
            );
        }
    }
